...
from processing_utils import read_csv

data_path = Path().cwd().parent.joinpath('data', 'my_test.tsv')

model_path = Path().cwd().parent.joinpath('model', 'model_epoch_20_f1_0.8689704902001734.pth')
mapper_path = Path().cwd().parent.joinpath('model', 'label_mapper.json')
